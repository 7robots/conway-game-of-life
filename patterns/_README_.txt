...
Database compiled on: Fri, Feb 13 2026
Downloaded from: conwaylife.com/patterns/all.zip

This pattern database contains 8525 pattern files for several hundred patterns in Conway's Game of Life and related cellular automata. All small patterns are provided in the RLE file format, and many patterns are provided in the plaintext .cells file format as well. The file formats are:
